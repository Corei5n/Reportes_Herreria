...
export const quoteSchema = z.object({
  ...
  obraDireccion: z.string().trim().optional().or(z.literal("")),
  ...
  ivaActivo: z.boolean(),
  anticipoPorcentaje: z.coerce.number().min(0, "El anticipo no puede ser negativo.").optional(),
  tiempoEntregaDias: z.coerce.number().min(0, "Los días de entrega no pueden ser negativos.").optional(),
  garantiaDias: z.coerce.number().min(0, "Los días de garantía no pueden ser negativos.").optional(),
  vigenciaDias: z.coerce.number().min(0, "La vigencia no puede ser negativa.").optional(),
